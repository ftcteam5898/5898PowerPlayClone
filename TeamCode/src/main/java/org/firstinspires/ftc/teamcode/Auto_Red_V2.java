...
@Autonomous(name = "Auto_Red_V2", group = "Auto_Red")
@Disabled
public class Auto_Red_V2 extends LinearOpMode
{
     ...
     */
    //private static final String TFOD_MODEL_ASSET = "PowerPlay_RedDucks.tflite";
    private static final String TFOD_MODEL_FILE  = "PowerPlay_RedDucks.tflite";
    ...
    public void runOpMode() {
        ...
        if (opModeIsActive()) {
            ...
            if (label.equals("purpleDuck"))
            {
                // go forward 1 tile stafe left 1 tile
                forwardAmt(1000, .3);
                strafe(-1200, .2);
            }
            else if (label.equals("yellowDuck"))
            {
                // go forward 1 tile
                forwardAmt(1000, .3);
            }
