...
import org.firstinspires.ftc.teamcode.FTCLib.commands.auto.MonkeCommandsRight;
    ...
    public void initialize() {
        ...
        telemetry.update();
            ...
            schedule(new WaitUntilCommand(this::isStarted)
                    ...
                    .andThen(new MonkeCommandsRight(driveSubsystem, liftSubsystem, clawSubsystem, tagID)));
                    //.andThen(new GorillaCommandGroup(driveSubsystem, liftSubsystem, clawSubsystem, tagID)));
                    //.andThen(new GorillaCommandGroupRight(driveSubsystem, liftSubsystem, clawSubsystem, tagID)));
        }
