...
public class GorillaCommandGroup extends SequentialCommandGroup {
    private final Pose2d startPos = new Pose2d(63.0, -36.0, 180.0);
    public ElapsedTime timer = new ElapsedTime();
    private double timeToLift;

    public GorillaCommandGroup(MecanumDriveSubsystem mecanumDriveSubsystem, LiftSubsystem liftSubsystem,
        ...
        addCommands(
                ...
                new SelectCommand(new HashMap<Object, Command>() {{
                    put(1, new TrajectoryFollowerCommand(mecanumDriveSubsystem, traj12));
                    put(2, new TrajectoryFollowerCommand(mecanumDriveSubsystem, traj13));
                    put(3, new TrajectoryFollowerCommand(mecanumDriveSubsystem, traj14));
