...
public class GorillaCommandGroupRight extends SequentialCommandGroup {
    ...
    public GorillaCommandGroupRight(MecanumDriveSubsystem mecanumDriveSubsystem, LiftSubsystem liftSubsystem,
        ...
        Trajectory traj10 = mecanumDriveSubsystem.trajectoryBuilder(traj9.end())
                .lineToSplineHeading(new Pose2d(-10.0, -24.0, Math.toRadians(0.0)))
                .build();
        ...
        Trajectory traj12 = mecanumDriveSubsystem.trajectoryBuilder(traj11.end())
                .lineToSplineHeading(new Pose2d(-12.0, -11.0, Math.toRadians(270.0)))
                .build();
        // second position
        ...
        Trajectory traj14 = mecanumDriveSubsystem.trajectoryBuilder(traj11.end())
                .lineToSplineHeading(new Pose2d(-12.0, -58.5, Math.toRadians(0.0)))
                .build();
